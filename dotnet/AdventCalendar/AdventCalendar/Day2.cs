...
namespace AdventCalendar
{
    ...
    public class Day2
    {
        ...
        {
            return ProcessPresents(input, CalculatePresentArea);
        }
        ...
        private int CalculatePresentArea(int width, int height, int depth, int min1, int min2)
        {
            return 2 * width * height + 2 * height * depth + 2 * width * depth + min1 * min2;
        }

        private int CalculateRibbonLength(int width, int height, int depth, int min1, int min2)
        {
            return width * height * depth + 2 * min1 + 2 * min2;
        }
    }
}
