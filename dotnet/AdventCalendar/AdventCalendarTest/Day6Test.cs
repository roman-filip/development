...
namespace AdventCalendarTest
{
    ...
    public class Day6Test
    {
        ...
        {
            var result = _day6.Part1("turn on 0,0 through 999,999");
        ...
        {
            var result = _day6.Part1("toggle 0,0 through 999,0");
        ...
        {
            var result = _day6.Part1("turn off 499,499 through 500,500");
        ...
        {
            var result = _day6.Part2("turn on 0,0 through 0,0");
        ...
        {
            var result = _day6.Part2("toggle 0,0 through 999,999");
        ...
        {
            var result = _day6.Part2(_input);
            Assert.AreEqual(14687245, result);
        }

        private const string _input = @"toggle 461,550 through 564,900
