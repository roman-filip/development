...
0 -> e
NOT e -> f");
            Assert.AreEqual(65535, result["f"]);
        }
...
123 -> x");
        ...
        {
            var result = _day7.Part1(_input1);
            Assert.AreEqual(956, result["a"]);
        }

        [TestMethod]
        public void Part2Test1()
        {
            var result = _day7.Part1(_input2);
            Assert.AreEqual(40149, result["a"]);
        }
